...
<div class="row">
    <div class="col-xs-12">
        ...
        <ul>
            ...
            <li>Beiträge kann man über den Blog ansehen und mit weiterlesen komplett anzeigen lassen</li>
            <li>Ist man angemeldet kann man die Beiträge, die von diesem User erstellt wurden löschen</li>
            <li>Meldet man sich als "admin" an (Passwort : 0000) kann man alle Beiträge löschen!</li>
            <li>Ist man angemeldet kann man sich mit dem Abmelden-Button wieder abmelden</li>
            <li>Der Admin hat die Möglichkeit alle angemeldeten zu sehen und diese zu löschen</li>
